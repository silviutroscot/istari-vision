console.debug("app logic loaded");
export class AppLogic extends HTMLElement {
    ...
    updatePrices() {
        const priceEgldEl = document.querySelector('#section-egld h3 span');
        const priceMexEl = document.querySelector('#section-mex h3 span');
    ...
    fetchStakingProviders() {
        const selectProviderEl = document.querySelector('select[name="egld-staking-provider"]');
    ...
    handleInputEvent(name, value) {
        ...
        switch (name) {
            case 'toggle-egld-only':
                ...
                const mexInputsEl = document.querySelectorAll('#section-mex input');
                const egldPctEl = document.querySelector('input[name="egld-pct"]');
    ...
    handleSubmit() {
        ...
        const request = {};
        const egldInputsEl = document.querySelectorAll('#section-egld input');
        ...
        const egldSelectsEl = document.querySelectorAll('#section-egld select');
    ...
    connectedCallback() {
        ...
        const targetDateEl = document.querySelector('input[name="target-date-days"]');
...
export class RewardDisplay extends HTMLElement {
    constructor(strategyName, result) {
        super();
        this.result = result || {
            ProfitInEgld: "",
            ProfitInMex: "",
